...
function App() {
  ...
  return (
    <div className="my-20 max-w-lg mx-auto bg-white shadow p-10">
      ...
      <input 
        type='range'
        className="w-full h-6 bg-gray-200 accent-rose-500 hover:accent-rose-600"
      ...
      <p className='text-center my-10 text-5xl font-extrabold text-purple-600'>
        {formatearDinero(cantidad)}
        </p>
      
        <h2 className='text-2xl font-extrabold text-gray-500 text-center'>
          Elige un <span className='text-purple-600'>plazo</span> a pagar
        </h2>
        ...
        <div className='my-5 space-y-3 bg-gray-100 p-5'>
          <h2 className='text-2xl font-extrabold text-gray-500 text-center'>
            Resumen <span className='text-purple-600'>de pagos</span>
          </h2>
